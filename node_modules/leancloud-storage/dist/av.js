...
var comments = ["Browser" || 'Node.js'].concat(__webpack_require__(21));
...
function setup(env) {
  ...
  createDebug.humanize = __webpack_require__(28);
...
module.exports = function (AV) {
  ...
  /** @lends AV.User.prototype */{
    ...
    linkWithWeapp: function linkWithWeapp() {
      ...
      return getWeappLoginCode().then(function (code) {
        return _this2._linkWith(PLATFORM_WEAPP, { code: code });
      });
    },
    ...
    loginWithWeapp: function loginWithWeapp(options) {
      ...
      return getWeappLoginCode().then(function (code) {
        return _this3.loginWithAuthData({ code: code }, PLATFORM_WEAPP, options);
      });
    },
  ...
  /** @lends AV.User */{
    ...
    loginWithWeapp: function loginWithWeapp(options) {
      ...
      return getWeappLoginCode().then(function (code) {
        return _this6.loginWithAuthData({ code: code }, PLATFORM_WEAPP, options);
      });
    },
