...
(function() {
	...
	e = function() {
		...
		r.prototype.connect = function() {
			...
			a = this._parseConnect.apply(this, r);u = a[0], this.connectCallback = a[1], s = a[2];
			if (typeof this.debug === "function") {
			...
			this.ws.onmessage = function(i) {
				return function(r) {
					...
					for (d = 0, g = b.length; d < g; d++) {
						f = b[d];switch (f.command) {
						case "CONNECTED":
							if (typeof i.debug === "function") {
								i.debug("connected to server " + f.headers.server)
							}
							i.connected = true;i._setupHeartbeat(f.headers);m.push(typeof i.connectCallback === "function" ? i.connectCallback(f) : void 0);
							break;case "MESSAGE":
							p = f.headers.subscription;l = i.subscriptions[p] || i.onreceive;
							if (l) {
								a = i;
			...
			this.ws.onclose = function(t) {
				...
				return function() {
					...
					u["heart-beat"] = [ t.heartbeat.outgoing, t.heartbeat.incoming ].join(",");return t._transmit("CONNECT", u)
				}
			}(this)
		};
		r.prototype.disconnect = function(t, e) {
			...
			this.ws.onclose = null;this.ws.close();this._cleanUp();return typeof t === "function" ? t() : void 0
		};
		...
		r.prototype.subscribe = function(t, e, n) {
			...
			n.destination = t;
			this.subscriptions[n.id] = e;this._transmit("SUBSCRIBE", n);
			i = this;return {
				id : n.id,
		...
		r.prototype.begin = function(t) {
			var e,
				n;
			n = t || "tx-" + this.counter++;this._transmit("BEGIN", {
				transaction : n
			});
			e = this;return {
				id : n,
		...
		r.prototype.ack = function(t, e, n) {
			...
			n["message-id"] = t;
			n.subscription = e;return this._transmit("ACK", n)
		};
		r.prototype.nack = function(t, e, n) {
			...
			n["message-id"] = t;
			n.subscription = e;return this._transmit("NACK", n)
		};return r
	}();
	i = {
		VERSIONS : {
